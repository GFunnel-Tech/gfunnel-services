...
const budgetTiers = [{
  ...
  features: ["Meta (Facebook + Instagram + Messenger)", "Local targeting (30-mile radius)", "Plai.io platform management", "Flows AI voice callbacks (standard queue)", "Lead Connector CRM integration", "2-3 ad creative variations", "Monthly performance reports", "Monthly strategy sessions", "Expected: 50-70 qualified leads/mo @ $28-40 CPL"],
  recommended: false
}, {
  name: "Growth",
  budget: "$5,000/mo",
  platform: "Multi-Platform",
  features: ["Meta + Google (Search + Pmax) + YouTube", "Extended targeting (50-mile radius)", "Plai.io advanced automation", "Flows AI priority queue + advanced routing", "Lead Connector with automation workflows", "5-7 ad creative variations", "Bi-weekly performance reports", "Bi-weekly optimization calls", "Expected: 120-180 qualified leads/mo @ $28-42 CPL"],
  recommended: true
}, {
  name: "Premium",
  budget: "$10,000/mo +",
  platform: "Full Multi-Channel",
  features: ["Meta, Google Suite, YouTube, LinkedIn, Local Service Ads, Direct Mail", "Multi-region campaign coverage", "Plai.io enterprise features + dedicated support", "Flows AI VIP queue + white-glove service", "Lead Connector advanced automation + custom integrations", "10+ ad creative variations", "Weekly performance reports + custom dashboards", "Weekly strategy sessions + dedicated account manager", "Expected: 300-400 qualified leads/mo @ $25-35 CPL"],
  recommended: false
}];
